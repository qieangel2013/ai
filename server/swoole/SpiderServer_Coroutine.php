...
class SpiderServer
{
    ...
    {
        $this->server = new swoole_server('0.0.0.0',9588);
    ...
    public function onTask($serv, $task_id, $from_id, $data)
    {
        ...
        $errcount=0;
        $this->getresult($tmp_data,$errcount);
   ...
   private function distance_pre($keyword) {
    ...
    private function getresult($data,$errcount){
            ...
            case 'get':
                ...
                if(isset($tmppdata)){
                	...
                	foreach ($resdata as $k => $v) {
                        ...
                        $this->queue->push(json_encode($redata,true));
                	}
                }else{
                     $log = array(
                                    'path' => dirname(__DIR__) .'/log/'.date('Ymd',time()).'/'.date('Ymd',time()).'.log', 
